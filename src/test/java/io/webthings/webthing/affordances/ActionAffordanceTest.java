...
public class ActionAffordanceTest {
    ...
    public void testGetInput() {
        ...
        final DataSchema ds =
                DataSchema.newInstance(DataSchema.typeId.tiBoolean);
        Common.checkGetter(ActionAffordance.class, "Input", "input", ds);
    }
    ...
    public void testSetInput() {
        ...
        final DataSchema ds =
                DataSchema.newInstance(DataSchema.typeId.tiBoolean);
        Common.checkSetter(ActionAffordance.class,
                           "Input",
                           DataSchema.class,
                           "input",
                           ds);
    ...
    public void testGetOutput() {
        ...
        final DataSchema ds =
                DataSchema.newInstance(DataSchema.typeId.tiBoolean);
        Common.checkGetter(ActionAffordance.class, "Output", "output", ds);
    }
    ...
    public void testGetSafe() {
        ...
        Common.checkGetter(ActionAffordance.class, "Safe", "safe", true);
    }
    ...
    public void testGetIdempotent() {
        ...
        Common.checkGetter(ActionAffordance.class,
                           "Idempotent",
                           "idempotent",
                           true);
    }
    ...
    public void testAsJSON() {
        ...
        try {
            ...
            assertTrue("Action desc check 1 ",
                       o.getString("description").equals("desc"));
            assertTrue("Action title check 1 ", o.has("title"));
            assertTrue("Action title check 1 ",
                       o.getString("title").equals("title"));
            assertTrue("Action forms 1", o.getJSONArray("forms").length() == 1);
            assertTrue("Action forms 2",
                       o.getJSONArray("forms")
                        .getJSONObject(0)
                        .get("href")
                        .equals("http://1.2.3.4"));
            assertTrue("Action Input 1", o.has("input"));
            assertTrue("Action Input 2",
                       o.getJSONObject("input")
                        .getString("type")
                        .equals("boolean"));
            assertTrue("Action Output 1", o.has("output"));
            assertTrue("Action Output 2",
                       o.getJSONObject("output")
                        .getString("type")
                        .equals("null"));
        } catch (Exception e) {
    ...
    public void testFromJSON() throws Exception {
        ...
        try {
            ...
            assertTrue("Description",
                       aa.getDefaultDescription().equals("desc"));
            ...
            assertTrue("Forms 2",
                       aa.getForms()
                         ...
                         .equals("http://1.2.3.4"));
            assertTrue("Input 1",
                       aa.getInput().getJSONType() ==
                               DataSchema.typeId.tiBoolean);
            assertTrue("Output 1",
                       aa.getOutput().getJSONType() ==
                               DataSchema.typeId.tiNull);
        } catch (Exception e) {
            fail("Got exception : " + e.toString());
        }
    }
