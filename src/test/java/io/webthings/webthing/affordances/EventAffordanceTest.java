...
public class EventAffordanceTest {
    ...
    public void testSetSubscription() {
        ...
        Common.checkSetter(EventAffordance.class,
                           "Subscription",
                           DataSchema.class,
                           "subscription",
                           ds);
    ...
    public void testGetSubscription() {
        ...
        final DataSchema ds =
                DataSchema.newInstance(DataSchema.typeId.tiBoolean);
        Common.checkGetter(EventAffordance.class,
                           "Subscription",
                           "subscription",
                           ds);
    }
    ...
    public void testGetData() {
        ...
        final DataSchema ds =
                DataSchema.newInstance(DataSchema.typeId.tiBoolean);
        Common.checkGetter(EventAffordance.class, "Data", "data", ds);
    }
    ...
    public void testAsJSON() {
        ...
        try {
            ...
            assertTrue("Cancellation 2",
                       canc.getString("type").equals("boolean"));
    ...
    public void testFromJSON() throws Exception {
        ...
        assertTrue("Cancellation 3 ",
                   ds.getJSONType() == DataSchema.typeId.tiBoolean);

        ds = pa.getSubscription();
        assertTrue("Subscription 1 ", ds != null);
        assertTrue("Subscription 2 ", ds instanceof NullSchema);
        assertTrue("Subscription 3 ",
                   ds.getJSONType() == DataSchema.typeId.tiNull);
