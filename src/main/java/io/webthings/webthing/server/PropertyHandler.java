...
public class PropertyHandler extends BaseHandler {
    ...
    public NanoHTTPD.Response get(RouterNanoHTTPD.UriResource uriResource,
        ...
        if (isWebSocketRequested(session)) {
            ...
            final NanoWSD.WebSocket webSocket =
                    new ThingWebSocket(session, true, path);
    ...
    private NanoHTTPD.Response handleProperty(RouterNanoHTTPD.UriResource uriResource,
                                              Map<String, String> urlParams,
                                              NanoHTTPD.IHTTPSession session,
                                              String methodName) {
        ...
        for (final Form f : ia.getForms()) {
            ...
            if (path.equals(thisPath)) {
                ...
                thisOp = oplist != null && oplist.size() > 0 ?
                         oplist.get(0) :
                         null;
                if (thisOp != null) {
    ...
    private JSONObject readProperty(RouterNanoHTTPD.UriResource uriResource,
                                    Map<String, String> urlParams,
                                    NanoHTTPD.IHTTPSession session)
    ...
    private void writeProperty(RouterNanoHTTPD.UriResource uriResource,
                               Map<String, String> urlParams,
                               NanoHTTPD.IHTTPSession session,
                               JSONObject jresp
