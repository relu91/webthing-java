...
public class FormMetadataHandler extends BaseHandler {
    ...
    private NanoHTTPD.Response handleRootForm(RouterNanoHTTPD.UriResource uriResource,
                                              Map<String, String> urlParams,
                                              NanoHTTPD.IHTTPSession session,
                                              String methodName) {
        ...
        try {
            ...
            switch (thisOp) {
                ...
                case readallproperties: {
                    obj = new JSONObject();
                    for (final Map.Entry<String, Property> e : owner.getProperties()
                                                                    .entrySet()) {
                        try {
                ...
                case writeallproperties: {
                    ...
                    final Set<String> jsonKeys =
                            new TreeSet<String>(json.keySet());
                    final Set<String> propertyKeys =
                            new TreeSet<String>(owner.getProperties().keySet());
